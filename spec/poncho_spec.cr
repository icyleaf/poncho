    ...
    describe "loads single file" do
      describe "disable overwrite" do
        ...
        describe "with path and test env" do
          ...
          it_equal ENV, "PONCHO_MYSQL_DATABASE", "poncho_test"
          it_equal ENV, "PONCHO_PATH", "/home/ci/github/poncho"
          clean_env "load_from_path/.env"
        ...
        describe "with path and production env" do
          ...
          it_equal ENV, "PONCHO_MYSQL_DATABASE", "poncho_production"
          it_equal ENV, "PONCHO_MYSQL_USER", "poncho"
          it_equal ENV, "PONCHO_MYSQL_PASSWORD", "p@nchO"
          it_equal ENV, "PONCHO_PATH", "/Users/icyleaf/workspaces/poncho"
          clean_env "load_from_path/.env"
